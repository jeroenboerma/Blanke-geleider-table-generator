...
#Dh, w = Properties_fun.dimensions()
#Material, Shape, Core, Location, Painted = Properties_fun.Component(Material, Shape, Core, Location, Painted)
...
def Qgen(I,T, Ro):
    ...
    Rac, Ys, Xs = Properties_fun.Rac(Rdc, Shape, Core, Dh, ID, rho0, L, alpha, T, w)
    Qgen = I**2*Rac

    return Qgen, Rac

#Heat lost due to convection
def Qconv(T, Te, Shape, Location, Dh, A, L):
    if Location == "Inside":
